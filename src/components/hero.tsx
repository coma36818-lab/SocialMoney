...
export function Hero() {
  return (
    <section className="container py-20 md:py-32">
      <div className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-primary/10 to-accent/10 p-8 md:p-16 shadow-2xl">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="backdrop-blur-sm">
              <Link href="#join-creators">Partecipa Anche Tu</Link>
            </Button>
          </div>
        </div>
      </div>
