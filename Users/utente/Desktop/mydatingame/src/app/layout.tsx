...
const siteConfig = {
  ...
  ogImage: 'https://www.themoviedb.org/t/p/w1280/p4QY9sHCrKA4sTo0p41ay2a2S5L.jpg', // Specific image for Frankenstein
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'MyDatingame – Trends, Gossip, Fashion & Lifestyle Magazine 2025',
    ...
    images: [
      {
        ...
        width: 1280,
        height: 720,
        alt: `Trailer and news from ${siteConfig.name}`,
      },
    ],
  },
  twitter: {
